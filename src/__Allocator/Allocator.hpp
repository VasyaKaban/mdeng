...
namespace FireLand
{
	...
	public:
		...
		void Destroy(const BoundedBuffer &bounded_buffer, bool destroy_pool_on_empty);
		void Destroy(BoundedBuffer &&bounded_buffer, bool destroy_pool_on_empty);

		void Destroy(const BoundedImage &bounded_image, bool destroy_pool_on_empty);
	...
	inline void Allocator::Destroy(const BoundedBuffer &bounded_buffer, bool destroy_pool_on_empty)
	{
		hrs::assert_true_debug(IsCreated(), "Allocator isn't created yet!");
	...
	inline void Allocator::Destroy(const BoundedImage &bounded_image, bool destroy_pool_on_empty)
	{
		hrs::assert_true_debug(IsCreated(), "Allocator isn't created yet!");
