...
namespace FireLand
{
    ...
    class Memory : public hrs::non_copyable, public hrs::non_move_assignable
    {
    public:
        ...
        void
        Free(VkDevice device, const DeviceLoader& dl, const VkAllocationCallbacks* alc) noexcept;
