...
namespace FireLand
{
    ...
    public:
        ...
        void Free(const BoundedBlock& bb, MemoryPoolOnEmptyPolicy policy, ResourceType res_type);
        ...
        void Free(const BoundedBuffer& bounded_buffer, MemoryPoolOnEmptyPolicy policy);
        ...
        void Free(const BoundedImage& bounded_image, MemoryPoolOnEmptyPolicy policy);
    private:
