...
namespace FireLand
{
    class MemoryPoolLists : public hrs::non_copyable, public hrs::non_move_assignable
    {
    public:
        ...
        void
        Clear(VkDevice device, const DeviceLoader& dl, const VkAllocationCallbacks* alc) noexcept;
    ...
    private:
        std::array<PoolContainer, static_cast<std::size_t>(MemoryPoolType::MemoryPoolTypeMaxUnused)>
            pools;
    };
};
