...
namespace FireLand
{
    MaterialGroup::MaterialGroup(Shader* _parent_shader,
                                               ...
                                               bool _enabled)
    {
        ...
        auto in_it =
            render_groups.insert({mesh,
                                  RenderGroup(this,
                                              mesh,
                                              IndexPool(storage, init_size_power, rounding_size),
                                              _enabled)});
    ...
    const MaterialGroup::RenderGroupsContainer&
    MaterialGroup::shader_get_render_groups() const noexcept
    {
