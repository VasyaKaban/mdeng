...
namespace FireLand
{
    ...
    requires DeviceUtilizerCreatable<DU, VkDevice, Args...>
    {
        ...
        hrs::assert_true_debug(std::ranges::find(physical_devices, physical_device) !=
        ...
        device_utilizers.push_back(
            std::unique_ptr<DeviceUtilizer>(new DeviceUtilizer(std::move(*du_exp))));
