...
namespace hrs
{
	...
	template<typename ...Args>
	assert_true(std::FILE *fd, bool, std::format_string<Args...>, Args &&...) -> assert_true<Args...>;
	...
	template<typename ...Args>
	assert_true_debug(std::FILE *fd, bool, std::format_string<Args...>, Args &&...) -> assert_true_debug<Args...>;
