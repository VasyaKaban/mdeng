...
namespace hrs
{
	...
	{
		using type = std::conditional_t<std::is_lvalue_reference_v<C>, std::add_lvalue_reference_t<O>, O>;
	};
	...
	{
		using type = std::conditional_t<std::is_rvalue_reference_v<C>, std::add_rvalue_reference_t<O>, O>;
	};
