...
HRS_ADD_TEST_ON_ENV(::hrs::test::environment::get_global_environment(), NAME __VA_OPT__(,) __VA_ARGS__)
...
HRS_TEST_ON_ENV(::hrs::test::environment::get_global_environment(), NAME __VA_OPT__(,) __VA_ARGS__)
...
HRS_CLASS_TEST_ON_ENV_DECL(::hrs::test::environment::get_global_environment(), NAME __VA_OPT__(,) __VA_ARGS__)
...
HRS_CLASS_TEST_ON_ENV(::hrs::test::environment::get_global_environment(), NAME __VA_OPT__(,) __VA_ARGS__)
